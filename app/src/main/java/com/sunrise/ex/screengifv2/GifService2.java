...
public class GifService2 extends Service {
    ...
    private Runnable BitmapStr = new Runnable() {
        ...
        public void run() {
            ...
            sharedPath = preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY2", "");

            if(!sharedPath.equals("")) {
                File f = new File(sharedPath);
                if (f.exists()) {
                    getBitmap();
                    mHandle.postDelayed(this,preferences.getInt("com.sunrise.ex.screengifv2.DELAY_KEY2",100));
                } else {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        aw.updateAppWidget(aw.getAppWidgetIds(new ComponentName(getApplicationContext(),ScreenGifWidgetProvider2.class)),
                new RemoteViews(getApplicationContext().getPackageName(), R.layout.widget_template));

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        mHandle.postDelayed(BitmapStr, preferences.getInt("com.sunrise.ex.screengifv2.DELAY_KEY2",100) );

        Intent ReceIntent = new Intent(getApplicationContext(),ScreenGifWidgetProvider2.class);
    ...
    public void getBitmap(){
        ...
        if(!preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY2", "").equals("")) {
            sharedPath = preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY2", "");
        ...
        Bitmap bit = Bitmap.createBitmap(preferences.getInt("com.sunrise.ex.screengifv2.WIDTH_KEY2",400)
                , preferences.getInt("com.sunrise.ex.screengifv2.HIGH_KEY2",300), Bitmap.Config.ARGB_8888);
        ...
        int[] appWidgetIDs = appWidgetMan
                .getAppWidgetIds(new ComponentName(getApplicationContext(), ScreenGifWidgetProvider2.class));
