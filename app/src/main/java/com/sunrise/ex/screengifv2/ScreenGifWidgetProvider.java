...
public class ScreenGifWidgetProvider extends AppWidgetProvider {
    ...
    public ScreenGifWidgetProvider() {
        super();
    }
        ...
        screenoffReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(intent.getAction().equals(Intent.ACTION_BOOT_COMPLETED)){
                    ...
                    Intent in3 = new Intent(context, GifService.class);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        pathToUse = preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY", "");
