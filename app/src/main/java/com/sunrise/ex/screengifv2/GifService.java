...
public class GifService extends Service {
    ...
    private Runnable BitmapStr = new Runnable() {
        ...
        public void run() {
            ...
            sharedPath = preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY", "");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        aw.updateAppWidget(aw.getAppWidgetIds(new ComponentName(getApplicationContext(),ScreenGifWidgetProvider.class)),
                new RemoteViews(getApplicationContext().getPackageName(), R.layout.widget_template));

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

            mHandle.postDelayed(BitmapStr, preferences.getInt("com.sunrise.ex.screengifv2.DELAY_KEY",100) );

            Intent ReceIntent = new Intent(getApplicationContext(),ScreenGifWidgetProvider.class);
    ...
    public void getBitmap(){
        ...
        if(!preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY", "").equals("")) {
            sharedPath = preferences.getString("com.sunrise.ex.screengifv2.PATH_KEY", "");
        ...
        Bitmap bit = Bitmap.createBitmap(preferences.getInt("com.sunrise.ex.screengifv2.WIDTH_KEY",400)
                , preferences.getInt("com.sunrise.ex.screengifv2.HIGH_KEY",300), Bitmap.Config.ARGB_8888);
        ...
        int[] appWidgetIDs = appWidgetMan
                .getAppWidgetIds(new ComponentName(getApplicationContext(), ScreenGifWidgetProvider.class));
